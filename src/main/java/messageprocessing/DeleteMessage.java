...
public class DeleteMessage extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            String sql;
            if (isImage) {
                sql = "UPDATE messages SET imagePath = DEFAULT WHERE time = ? AND imagePath = ? AND outgoing_msg_id = ?";
            } else {
                sql = "UPDATE messages SET msg = DEFAULT WHERE time = ? AND msg = ? AND outgoing_msg_id = ?";
            }
