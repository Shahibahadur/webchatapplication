...
/**
 * Servlet implementation class EditGroupMessage
 */
@WebServlet("/editGroupMessage")
public class EditGroupMessage extends HttpServlet {
	    ...
	    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	        ...
	        try {
	            ...
	            try (Connection conn = new DatabaseConfig().getConnection()) {
	                String updateQuery = "UPDATE group_messages SET message_text = ? WHERE timestamp = ? AND sender_id = ?";
